...
const cssVariablePrefix = 'shiki'

// Replace those `#001`, `#002`, ... with CSS variables (Ex: --shiki-color-background, --shiki-color-text, ...)
...
const kenanipTheme: Shiki.IThemeRegistration = {
  name: 'kenanip',
  type: 'dark',
  bg: `var(--${cssVariablePrefix}-${colorReplacements['#000']})`,
  fg: `var(--${cssVariablePrefix}-${colorReplacements['#001']})`,
  settings: tokens
}

export { kenanipTheme, colorReplacements, cssVariablePrefix }
